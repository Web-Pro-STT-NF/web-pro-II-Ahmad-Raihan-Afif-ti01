...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url('dist/img/logoNF.png') ?>">
...
<body>
            ...
            <div class="relative -mx-4 flex items-center justify-between">
                <div class="w-60 max-w-full px-4">
                    <a href="index.html" class="navbar-logo block w-full py-5">
                        <img src="<?php echo base_url('dist/img/logoENEF.jpg') ?>" alt="logo" class="header-logo w-full lingkaran" />
                    </a>
                </div>
                <div class="flex w-full items-center justify-between px-4">
                            ...
                            <ul class="blcok lg:flex">
                                ...
                                <li class="submenu-item group relative">
                                    ...
                                    <div class="submenu relative top-full left-0 hidden w-[250px] rounded-sm bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full">
                                        ...
                                        <a href="<?php echo base_url('index.php/register') ?>" class="block rounded py-[10px] px-4 text-sm text-body-color hover:text-primary">
                                            Sign Up Page
                                        </a>
                                        <a href="<?php echo base_url('index.php/login') ?>" class="block rounded py-[10px] px-4 text-sm text-body-color hover:text-primary">
                                            Sign In Page
                                        </a>
                    ...
                    <div class="hidden justify-end pr-16 sm:flex lg:pr-0">
                        ...
                        <a href="<?php echo base_url('index.php/register') ?>" class="signUpBtn rounded-lg bg-white bg-opacity-20 py-3 px-6 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">
                            Sign Up
                        </a>
                    </div>
                </div>
                ...
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        ...
                        <ul class="mb-10 flex flex-wrap items-center justify-center">
                            ...
                            <li>
                                <a href="https://github.com/Ahmadraihanafif" target="_blank" class="flex items-center py-4 px-6 text-base font-medium text-white transition duration-300 ease-in-out hover:opacity-70 sm:px-10">
                                    My Github
                                    <span class="pl-2">
    ...
    <section id="mahasiswa" class="w-full d-flex justify-content-center">
        <div class="container">
            <div class="table-responsive">
                <div class="row justify-content-centar">
                    ...
                    <table class="table table-hover table">
                        ...
                        <tbody class="mx-auto mb-[60px] max-w-[620px] text-center">
                            <?php
                            $nomor = 1;
